...
# Security: strip verbose/debug logging from release builds. Stream URLs and auth flows log
# token-bearing data at these levels; keeping them out of release APKs prevents logcat leaks.
# (Log.e/w/i are kept — error paths never log credentials and are needed for field reports.)
